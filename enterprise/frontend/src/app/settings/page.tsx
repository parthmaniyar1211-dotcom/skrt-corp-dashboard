          ...
          <CardContent className="p-6">
            <Tabs defaultValue="profile" className="flex flex-col space-y-6 w-full">
              ...
              <TabsContent value="profile" className="outline-none space-y-6 animate-in fade-in-50 duration-200">
                ...
                <form onSubmit={handleSaveChanges} className="space-y-4 max-w-4xl">
                  ...
                  <Button type="submit" className="bg-primary hover:bg-primary/95 text-primary-foreground font-semibold px-6 py-2 transition-all">
                    Save Changes
                  </Button>
                </form>
              </TabsContent>
              ...
              <TabsContent value="notifications" className="outline-none space-y-6 animate-in fade-in-50 duration-200">
                <div className="space-y-1">
